...
export const allForumTypes = new TupleSet(["LessWrong", "AlignmentForum", "EAForum", "FarmedAnimalWelfare"] as const);
...
export const hasRejectedContentSectionSetting = new PublicInstanceSetting<boolean>(
  "hasRejectedContentSection",
  false,
  "optional"
);
...
export const fmCrosspostSiteNameSetting = new PublicInstanceSetting<string | null>(
  "fmCrosspost.siteName",
  null,
  "optional"
);
export const fmCrosspostBaseUrlSetting = new PublicInstanceSetting<string | null>(
  "fmCrosspost.baseUrl",
  null,
  "optional"
);
...
// database.
export const ckEditorUploadUrlOverrideSetting = new PublicInstanceSetting<string | null>(
  "ckEditorOverride.uploadUrl",
  null,
  "optional"
); // Image Upload URL for CKEditor
export const ckEditorWebsocketUrlOverrideSetting = new PublicInstanceSetting<string | null>(
  "ckEditorOverride.webSocketUrl",
  null,
  "optional"
); // Websocket URL for CKEditor (for collaboration)
...
export const lowKarmaUserVotingCutoffDateSetting = new PublicInstanceSetting<string>(
  "lowKarmaUserVotingCutoffDate",
  "11-30-2022",
  "optional"
);
/** Currently LW-only; forum-gated in `userCanVote` */
export const lowKarmaUserVotingCutoffKarmaSetting = new PublicInstanceSetting<number>(
  "lowKarmaUserVotingCutoffKarma",
  1,
  "optional"
);
...
export const tabLongTitleSetting = new PublicInstanceSetting<string | null>(
  "forumSettings.tabLongTitle",
  null,
  "optional"
);
